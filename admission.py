...
class Admission:
    ...
    def error_text(self):
        """The upstream's own rejection message for a non-200 answer (``''`` when none was captured)."""
        ...
        try:
            ...
            while True:
                ...
                if response.status == 200:
                    ...
                    gate.error_body += chunk  # The rejection reason, e.g. "prompt is too long", bounded.
